...
namespace Sales_and_Inventory_System__Gadgets_Shop_
{
    public partial class frmStock : Form
    {
        ...
        private void auto()
        {
            txtStockID.Text = "ET-" + GetUniqueKey(6);
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Por favor recupere o nome do produto", "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtProductName.Focus();
                return;
            }
            if (txtQty.Text == "")
            {
                MessageBox.Show("Por favor insira a quantidade", "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtQty.Focus();
                return;
            }
            if (cmbSupplierName.Text == "")
            {
                MessageBox.Show("Selecione o nome do fornecedor", "Erro de entrada", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (txtQty.Text == "")
            {
                MessageBox.Show("Introduza a quantidade", "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtQty.Focus();
                return;
            }
            if (cmbSupplierName.Text == "")
            {
                MessageBox.Show("Selecionar o nome do fornecedor", "Erro na digitação", MessageBoxButtons.OK, MessageBoxIcon.Error);
                cmbSupplierName.Focus();
                return;
            }
            try
        ...
        private void cmbSupplierName_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);

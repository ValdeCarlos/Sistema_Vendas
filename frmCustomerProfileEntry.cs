...
namespace Sales_and_Inventory_System__Gadgets_Shop_
{
    public partial class frmCustomerProfileEntry : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (txtAddress.Text == "")
            {
                MessageBox.Show("Insira o endereço", "Erro de entrada", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtAddress.Focus();
                return;
            }
            if (txtCity.Text == "")
            ...
            {
                MessageBox.Show("Por favor, digite o número do contato.", "Erro de digitação", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtContactNo.Focus();
                return;
            }
            ...
            try
            {
                ...
                if (rdr.Read())
                {
                    MessageBox.Show("Este perfil já existe", "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
                ...
                cmd.Parameters.AddWithValue("@d7", txtEmail.Text);
                    ...
                    cmd.ExecuteReader();
                    MessageBox.Show("Salvo com Sucesso", "Detalhes do Funcinário", MessageBoxButtons.OK, MessageBoxIcon.Information);

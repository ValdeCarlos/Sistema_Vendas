...
namespace Sales_and_Inventory_System__Gadgets_Shop_
{
    public partial class frmSuppliers : Form
    {
        ...
        private void auto()
        {
            txtSupplierID.Text = "FO-" + GetUniqueKey(6);
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Insira o nome do fornecedor", "Erro de entrada", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtSupplierName.Focus();
                return;
            }
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@d8", txtNotes.Text);
                    ...
                    cmd.ExecuteReader();
                    MessageBox.Show("Salvo com sucesso", "Detalhes do fornecedor", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (MessageBox.Show("Deseja mesmo deletar o registro?", "Cadastro de Fornecedor", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == System.Windows.Forms.DialogResult.Yes)
                {
                    delete_records();
                }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@d8", txtNotes.Text);
                cmd.ExecuteReader();
                MessageBox.Show("Atualizado com sucesso", "Detalhes do fornecedor", MessageBoxButtons.OK, MessageBoxIcon.Information);
                btnUpdate.Enabled = false;
                if (con.State == ConnectionState.Open)
                {
                    con.Close();

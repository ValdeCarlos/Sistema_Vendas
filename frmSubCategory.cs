...
namespace Sales_and_Inventory_System__Gadgets_Shop_
{
        ...
        private void Reset()
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Deseja realmente excluir este registro?", "Confirmação", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtSubCategory.Focus();
                return;
            }
            ...
            try
            {
                ...
                if (rdr.Read())
                {
                    MessageBox.Show("O nome da subcategoria já existe", "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    txtSubCategory.Text = "";
                    txtSubCategory.Focus();
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtSubCategory.Text == "")
                {
                    MessageBox.Show("Por favor, insira a subcategoria", "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    txtSubCategory.Focus();
                    return;
                }
                con = new SqlConnection(cs.DBConn);

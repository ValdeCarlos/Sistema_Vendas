...
namespace Sales_and_Inventory_System__Gadgets_Shop_
{
    public partial class frmRecoveryPassword : Form
    {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            if (txtEmail.Text == "")
            {
                MessageBox.Show("Digite seu e-mail", "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtEmail.Focus();
                return;
            }
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    Msg.Subject = "Detalhes da sua senha";
                    ...
                    smtp.EnableSsl = true;
                    smtp.Send(Msg);
                    MessageBox.Show(("Senha enviada com sucesso " + ("\r\n" + "Verifique seu e-mail")), "Obrigado", MessageBoxButtons.OK, MessageBoxIcon.Information); this.Hide();
